...
test_add:
	iverilog -g2012 -I rtl -o build/tb_alu_add.vvp tb/tb_alu_add.v $(ALU)
	vvp build/tb_alu_add.vvp

test_sub:
	iverilog -g2012 -I rtl -o build/tb_alu_sub.vvp tb/tb_alu_sub.v $(ALU)
	vvp build/tb_alu_sub.vvp

test_logic:
	iverilog -g2012 -I rtl -o build/tb_alu_logic.vvp tb/tb_alu_logic.v $(ALU)
	vvp build/tb_alu_logic.vvp

test_shift:
	iverilog -g2012 -I rtl -o build/tb_alu_shift.vvp tb/tb_alu_shift.v $(ALU)
	vvp build/tb_alu_shift.vvp

test_mul:
	iverilog -g2012 -I rtl -o build/tb_alu_mul.vvp tb/tb_alu_mul.v $(ALU)
	vvp build/tb_alu_mul.vvp

test_div:
	iverilog -g2012 -I rtl -o build/tb_alu_divmod.vvp tb/tb_alu_divmod.v $(ALU)
